 ...
 * Config class
 * 
 * A classe de configuração do fluxo da aplicação é extremamente flexivel e pode ser alterada para diversas
 * formas simples de usabilidade, podendo substituir por exemplo o guzzle e suas configuração de timeout pelo Zend Http.
 * 
