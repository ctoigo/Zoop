 ...
 * ZoopClient class
 *
 * Essa classe é resonsavel por ser usada como primeira camada uma especie de guarda chuvas para todas as classes registradas
 * dentro de aplicação em formato de bundle, os bundles (classes que podem ser chaamdas seus metodos publicos por essa class cliente
 * são registrados dentro da classe Abstrata extendida pelo cliente Zoop\Zoop).
 * 
