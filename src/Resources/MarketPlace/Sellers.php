 ...
 * Class Sellers
 * 
 * Essa classe é resposavel por lidar com os usuarios dentro do marketplace ao nivel do marketplace zoop.
 * 
...
class Sellers extends Zoop {
     ...
     * getSeller function
     *
     * Pega os dados de um vendedor utilizando seu id como paramtro.
     *
