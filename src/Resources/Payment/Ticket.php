 ...
 * Ticket class
 * 
 * Essa classe é responsavel por gerar, hidratar com dados estatiocos e extrair os dados de interesse final de pagamento da zoop.
 * 
...
class Ticket extends Zoop {
     ...
     *
     * Prepara o boleto e preenche o mesmo com dados fixos utilizados na request para geração de boletos.
     * 
     * @param array $ticket
     * @param string $userId
     * @return array
     ...
     *
     * Processa o boleto na Zoop, e retorna somente os dados necessarios para pegar o boleto e mostrar dados de valor.
     *
     * @param array $ticket
     * @param string $userId
     ...
     *
     * Gera o boleto e retorna os dados principais do mesmo, como codigo de barras, url para download no s3 e mais.
     *
     * @param array $ticket
     * @param string $userId
     * @param null|string $referenceId
